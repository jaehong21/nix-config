...

{
  ...
  xdg.configFile."colima/default/generated.yaml" = {
    ...
    onChange = ''
      rm -f ${config.xdg.configHome}/colima/default/colima.yaml
      cp ${config.xdg.configHome}/colima/default/generated.yaml ${config.xdg.configHome}/colima/default/colima.yaml
      chmod u+w ${config.xdg.configHome}/colima/default/colima.yaml
    '';
