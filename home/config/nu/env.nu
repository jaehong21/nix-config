...
$env.TF_VAR_cloudflare_api_key = (open ($SECRETS_PATH)/cloudflare/api_key | str trim)
$env.TF_VAR_r2_access_key = (open ($SECRETS_PATH)/cloudflare/r2/access_key | str trim)
$env.TF_VAR_r2_secret_key = (open ($SECRETS_PATH)/cloudflare/r2/secret_key | str trim)
